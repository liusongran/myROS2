...
#if (DT_PUBLISHER_HPP==1)
printf("\n|rclcpp|publisher.hpp|do num compare|Pt-1 => start-timestamp: %ld", get_clocktime());
#endif
    bool inter_process_publish_needed =
      get_subscription_count() > get_intra_process_subscription_count();
#if (DT_PUBLISHER_HPP==1)
printf("\n|rclcpp|publisher.hpp|do num compare|Pt-1 => end-timestamp: %ld\n", get_clocktime());
#endif

    if (inter_process_publish_needed) {

#if (DT_PUBLISHER_HPP==1)
printf("\n|rclcpp|publisher.hpp|br1|publish->[do_intra_process_ros_message_publish_and_return_shared]|Pt-2 => start-timestamp: %ld", get_clocktime());
#endif
      auto shared_msg = this->do_intra_process_publish_and_return_shared(std::move(msg));
#if (DT_PUBLISHER_HPP==1)
printf("\n|rclcpp|publisher.hpp|br1|publish->[do_intra_process_ros_message_publish_and_return_shared]|Pt-2 => end-timestamp: %ld\n", get_clocktime());
#endif

#if (DT_PUBLISHER_HPP==1)
printf("\n|rclcpp|publisher.hpp|br1|publish->[do_inter_process_publish]|Pt-3 => start-timestamp: %ld", get_clocktime());
#endif
      this->do_inter_process_publish(*shared_msg);
#if (DT_PUBLISHER_HPP==1)
printf("\n|rclcpp|publisher.hpp|br1|publish->[do_inter_process_publish]|Pt-3 => end-timestamp: %ld\n", get_clocktime());
#endif

    } else {

#if (DT_PUBLISHER_HPP==1)
printf("\n|rclcpp|publisher.hpp|br2|publish->[do_intra_process_ros_message_publish]|Pt-2 => start-timestamp: %ld", get_clocktime());
#endif
      this->do_intra_process_publish(std::move(msg));
#if (DT_PUBLISHER_HPP==1)
printf("\n|rclcpp|publisher.hpp|br2|publish->[do_intra_process_ros_message_publish]|Pt-2 => end-timestamp: %ld\n", get_clocktime());
#endif
    }
  }
