...
#my_x_ticks          = ['0sub', '1sub', '3sub', '4sub', '5sub', '10sub']
#r_500hz_inter_hz    = np.array([499.6, 499, 499, 499, 499.7, 499.3])/500
#r_500hz_inter_cpu   = [18.94, 27.6, 41.74, 47.13, 70.65, 103]
...
#r_500hz_single_hz   = np.array([499.6, 499.5, 499.6, 499.6, 499.6, 499.6])/500
#r_500hz_single_cpu  = [18.94, 21.47, 43.78, 53.5, 63.96, 111.6]
...
#r_2000hz_inter_hz   = np.array([1996.5, 1987.9, 1962.4, 1965.6, 1935.3, 1503.45])/2000
#r_2000hz_inter_cpu  = [50, 85.04, 123.85, 135.17, 141.35, 152.31]
...
#r_2000hz_single_hz  = np.array([1996.5, 1993.8, 1979, 1958, 1945.19, 1620])/2000
#r_2000hz_single_cpu = [50, 71.1, 150.71, 185.3, 220.12, 387.04]
